(function () {
    ...
    app.service('AppMobileLinksService', [
        '$rootScope', '$http', '$q', 'CommonService', 'AmsService', function ($rootScope, $http, $q, CommonService, AmsService) {
            'use strict';
...
//# sourceMappingURL=app-mobile-links.srv.js.map
