		        ...
		        link: function (scope, element, attrs, ngModel) {
		            ...
		            if (ngModel) {
		                ...
		                var errors = {
		                    ...
		                    minLength: Helpers.getTranslation('Error_MinLength_Text') || 'Field must be at least {0} characters',
		                    maxLength: Helpers.getTranslation('Error_MaxLength_Text') || 'Field must be at most {0} characters'
		                };
